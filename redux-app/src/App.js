...
function App(props) {
  return (
    <div className="App">
      ...
      <button onClick={props.getHpData}>
        {props.isLoading ? "Loading" : "Get Houses"}
      </button>
      <h1 style={{ color: "white" }}>
        {props.houseCup.length > 0 &&
          `${props.houseCup} wins the House Cup!!!!`}
      </h1>
      <HpHouses
        houses={props.hpHouses}
        addPoints={props.addPoints}
        subtractPoints={props.subtractPoints}
      />
      <div>
